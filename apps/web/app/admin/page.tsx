...
export default async function AdminPage() {
  ...
  return (
    <main className="qa-shell space-y-4">
      ...
      <section className="qa-card grid gap-2 text-sm md:grid-cols-8">
        ...
        <Link href="/admin/tracks" className="rounded-xl border border-border/70 bg-surface p-4 underline">
          트랙 관리
        </Link>
