...
class Exam(Base):
    ...
    multiple_choice_score: Mapped[int] = mapped_column(Integer, nullable=False, default=1)
    subjective_score: Mapped[int] = mapped_column(Integer, nullable=False, default=3)
    coding_score: Mapped[int] = mapped_column(Integer, nullable=False, default=3)
...
class ExamQuestion(Base):
    ...
    correct_choice_indexes_json: Mapped[list[int] | None] = mapped_column(JSON, nullable=True)
...
class ExamAnswer(Base):
    ...
    selected_choice_indexes_json: Mapped[list[int] | None] = mapped_column(JSON, nullable=True)
