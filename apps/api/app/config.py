...
EXAM_RESOURCE_RETENTION_DAYS = int(os.getenv("EXAM_RESOURCE_RETENTION_DAYS", "7"))
EXAM_RESOURCE_RETENTION_BATCH_LIMIT = int(os.getenv("EXAM_RESOURCE_RETENTION_BATCH_LIMIT", "500"))
OPENAI_API_KEY = os.getenv("OPENAI_API_KEY", "")
OPENAI_BASE_URL = os.getenv("OPENAI_BASE_URL", "https://api.openai.com/v1")
EXAM_LLM_MODEL = os.getenv("EXAM_LLM_MODEL", "gpt-5-mini")
